...
export default function BookGuide() {
  ...
  return (
    ...
    >
      ...
      >
        <h2 style={{ marginBottom: '20px', fontSize: '2rem', color: 'rgba(0, 0, 0, 1)' }}>Tour Guide Booking</h2>
        <p style={{ marginBottom: '20px', color: 'rgba(0, 0, 0, 0.9)' }}>You have booked by a tourist. Here are the details:</p>
