  ...
  return (
    <div>
              ...
              <div className="container-box">
                ...
                <div className="content">
                  ...
                  {location.description.length > 100 && (
                    visibleDescriptions[location._id] ? (
                      <button
                        ...
                        onClick={() => handleSeeLessDescription(location._id)}
                      >
                        See less
                      </button>
                    ) : (
                      <button
                        ...
                        onClick={() => handleSeeMoreDescription(location._id)}
                      >
                        See more
                      </button>
                    )
                  ...
                  <div className="like-section">
                    <button
                      className={`like-button ${
                        likedLocations.includes(location._id) ? 'liked' : ''
                      }`}
                  ...
                  <div className="comments-section">
                    <h3>Comments</h3>
                    {location.comments
                      .slice(0, visibleComments[location._id] || 5)
                      .map((comment, index) => (
                    ...
                    {location.comments.length >
                      ...
                      <button
                        className="see-more-button"
                        onClick={() => handleSeeMoreComments(location._id)}
                      >
                        See more
                      </button>
                    )}
                    {visibleComments[location._id] > 5 && (
                      <button
                        className="see-less-button"
                        onClick={() => handleSeeLessComments(location._id)}
                      >
                        See less
                      </button>
                    )}
                    ...
                    />
                    <button
                      onClick={() => handleAddComment(location._id)}
      ...
      <section>
        <div className="container">
          <h1 className="title">
            Are you a Traveller? Share your experience with us
          </h1>
          <a href="/newLocation">
